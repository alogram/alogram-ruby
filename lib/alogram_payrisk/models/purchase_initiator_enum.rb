...
module AlogramPayRisk
  class PurchaseInitiatorEnum
    CARDHOLDER = "cardholder".freeze
    MERCHANT = "merchant".freeze

    def self.all_vars
      @all_vars ||= [CARDHOLDER, MERCHANT].freeze
    end
    ...
    def build_from_hash(value)
      return value if PurchaseInitiatorEnum.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #PurchaseInitiatorEnum"
    end
  end

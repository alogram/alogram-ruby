...
module AlogramPayRisk
  ...
  class Card < ApiModelBase
    ...
    def list_invalid_properties
      ...
      if !@issuer_country.nil? && @issuer_country.to_s.length > 64
        invalid_properties.push('invalid value for "issuer_country", the character length must be smaller than or equal to 64.')
      end
    ...
    def valid?
      ...
      return false if !@issuer_country.nil? && @issuer_country.to_s.length > 64
    ...
    def issuer_country=(issuer_country)
      if issuer_country.to_s.length > 64
        fail ArgumentError, 'invalid value for "issuer_country", the character length must be smaller than or equal to 64.'
      end

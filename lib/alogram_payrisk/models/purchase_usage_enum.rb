...
module AlogramPayRisk
  class PurchaseUsageEnum
    ...
    def self.all_vars
      @all_vars ||= [ONE_TIME, RECURRING, INSTALLMENT, UNSCHEDULED].freeze
    end
    ...
    def build_from_hash(value)
      return value if PurchaseUsageEnum.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #PurchaseUsageEnum"
    end
  end

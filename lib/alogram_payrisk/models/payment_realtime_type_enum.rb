...
module AlogramPayRisk
  class PaymentRealtimeTypeEnum
    ZELLE = "zelle".freeze
    RTP = "rtp".freeze
    FED_NOW = "fed_now".freeze
    FASTER_PAYMENTS = "faster_payments".freeze
    UPI = "upi".freeze

    def self.all_vars
      @all_vars ||= [ZELLE, RTP, FED_NOW, FASTER_PAYMENTS, UPI].freeze
    end
    ...
    def build_from_hash(value)
      return value if PaymentRealtimeTypeEnum.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #PaymentRealtimeTypeEnum"
    end
  end

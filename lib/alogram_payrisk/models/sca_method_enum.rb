...
module AlogramPayRisk
  class ScaMethodEnum
    NONE = "none".freeze
    N3DS_V1 = "3ds_v1".freeze
    N3DS_V2 = "3ds_v2".freeze
    ...
    def self.all_vars
      @all_vars ||= [NONE, N3DS_V1, N3DS_V2, OTP_SMS, BIOMETRIC, FIDO2, OTHER].freeze
    end
    ...
    def build_from_hash(value)
      return value if ScaMethodEnum.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ScaMethodEnum"
    end
  end

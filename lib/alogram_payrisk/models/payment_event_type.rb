...
module AlogramPayRisk
  class PaymentEventType
    ...
    CHARGEBACK_OUTCOME = "chargeback_outcome".freeze

    def self.all_vars
      @all_vars ||= [AUTHORIZATION, CAPTURE, SETTLEMENT, REFUND, DISPUTE, CHARGEBACK, CHARGEBACK_OUTCOME].freeze
    end
    ...
    def build_from_hash(value)
      return value if PaymentEventType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #PaymentEventType"
    end
  end

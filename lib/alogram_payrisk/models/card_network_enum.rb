...
module AlogramPayRisk
  class CardNetworkEnum
    ...
    def self.all_vars
      @all_vars ||= [VISA, MASTERCARD, AMEX, DISCOVER, JCB, UNIONPAY, OTHER].freeze
    end
    ...
    def build_from_hash(value)
      return value if CardNetworkEnum.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #CardNetworkEnum"
    end
  end

...
module AlogramPayRisk
  class EntryMethodEnum
    CHIP = "chip".freeze
    CONTACTLESS = "contactless".freeze
    MAGSTRIPE = "magstripe".freeze
    MANUAL_KEYED = "manual_keyed".freeze
    CARD_ON_FILE = "card_on_file".freeze
    WALLET_TOKEN = "wallet_token".freeze
    NETWORK_TOKEN = "network_token".freeze

    def self.all_vars
      @all_vars ||= [CHIP, CONTACTLESS, MAGSTRIPE, MANUAL_KEYED, CARD_ON_FILE, WALLET_TOKEN, NETWORK_TOKEN].freeze
    end
    ...
    def build_from_hash(value)
      return value if EntryMethodEnum.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #EntryMethodEnum"
    end
  end

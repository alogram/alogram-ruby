...
module AlogramPayRisk
  class AvsResultEnum
    ...
    def self.all_vars
      @all_vars ||= [Y, N, A, Z, U, R, S, G, B, C, D, M, P, X, W].freeze
    end
    ...
    def build_from_hash(value)
      return value if AvsResultEnum.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #AvsResultEnum"
    end
  end

...
module AlogramPayRisk
  class AgentProvider
    ...
    ALOGRAM = "alogram".freeze
    OTHER = "other".freeze

    def self.all_vars
      @all_vars ||= [GOOGLE, OPENAI, ANTHROPIC, ALOGRAM, OTHER].freeze
    end
    ...
    def build_from_hash(value)
      return value if AgentProvider.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #AgentProvider"
    end
  end

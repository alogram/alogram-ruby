...
module AlogramPayRisk
  class InteractionTypeEnum
    LOGIN = "login".freeze
    FEATURE_USE = "feature_use".freeze
    SETTING_CHANGE = "setting_change".freeze
    PAGE_VIEW = "page_view".freeze
    N3RD_PARTY_EVENT = "3rd_party_event".freeze
    CUSTOM_EVENT = "custom_event".freeze

    def self.all_vars
      @all_vars ||= [LOGIN, FEATURE_USE, SETTING_CHANGE, PAGE_VIEW, N3RD_PARTY_EVENT, CUSTOM_EVENT].freeze
    end
    ...
    def build_from_hash(value)
      return value if InteractionTypeEnum.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #InteractionTypeEnum"
    end
  end

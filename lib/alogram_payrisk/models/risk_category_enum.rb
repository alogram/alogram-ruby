...
module AlogramPayRisk
  class RiskCategoryEnum
    GEOGRAPHY = "geography".freeze
    ...
    def self.all_vars
      @all_vars ||= [GEOGRAPHY, IDENTITY, BEHAVIOR, TRANSACTION, NETWORK].freeze
    end
    ...
    def build_from_hash(value)
      return value if RiskCategoryEnum.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #RiskCategoryEnum"
    end
  end

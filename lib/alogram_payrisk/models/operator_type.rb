...
module AlogramPayRisk
  class OperatorType
    ...
    AUTONOMOUS_AGENT = "autonomous_agent".freeze

    def self.all_vars
      @all_vars ||= [HUMAN, SYSTEM, AUTONOMOUS_AGENT].freeze
    end
    ...
    def build_from_hash(value)
      return value if OperatorType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #OperatorType"
    end
  end

...
module AlogramPayRisk
  ...
  class MerchantContext < ApiModelBase
    ...
    def list_invalid_properties
      ...
      if !@merchant_country.nil? && @merchant_country.to_s.length > 64
        invalid_properties.push('invalid value for "merchant_country", the character length must be smaller than or equal to 64.')
      end
    ...
    def valid?
      ...
      return false if !@merchant_country.nil? && @merchant_country.to_s.length > 64
    ...
    def merchant_country=(merchant_country)
      if merchant_country.to_s.length > 64
        fail ArgumentError, 'invalid value for "merchant_country", the character length must be smaller than or equal to 64.'
      end

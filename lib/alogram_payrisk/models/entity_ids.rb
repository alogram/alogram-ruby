...
module AlogramPayRisk
  ...
  class EntityIds < ApiModelBase
    ...
    def client_id=(client_id)
      ...
      if client_id.to_s.length < 5
        fail ArgumentError, 'invalid value for "client_id", the character length must be greater than or equal to 5.'
      end
    ...
    def member_id=(member_id)
      ...
      if member_id.to_s.length < 5
        fail ArgumentError, 'invalid value for "member_id", the character length must be greater than or equal to 5.'
      end

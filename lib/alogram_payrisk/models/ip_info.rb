...
module AlogramPayRisk
  class IpInfo < ApiModelBase
    ...
    def list_invalid_properties
      ...
      if !@country.nil? && @country.to_s.length > 64
        invalid_properties.push('invalid value for "country", the character length must be smaller than or equal to 64.')
      end
    ...
    def valid?
      ...
      return false if !@country.nil? && @country.to_s.length > 64
    ...
    def country=(country)
      if country.to_s.length > 64
        fail ArgumentError, 'invalid value for "country", the character length must be smaller than or equal to 64.'
      end

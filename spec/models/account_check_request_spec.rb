...
# Unit tests for AlogramPayRisk::AccountCheckRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::AccountCheckRequest do
  #let(:instance) { AlogramPayRisk::AccountCheckRequest.new }

  describe 'test an instance of AccountCheckRequest' do
    it 'should create an instance of AccountCheckRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::AccountCheckRequest)
    end
  end
  ...
  describe 'test attribute "event_subtype"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["signup", "login", "password_reset", "mfa_reset", "setting_change"])
      # validator.allowable_values.each do |value|
      #   expect { instance.event_subtype = value }.not_to raise_error
      # end
    end
  end

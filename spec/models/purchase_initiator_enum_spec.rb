...
# Unit tests for AlogramPayRisk::PurchaseInitiatorEnum
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::PurchaseInitiatorEnum do
  #let(:instance) { AlogramPayRisk::PurchaseInitiatorEnum.new }

  describe 'test an instance of PurchaseInitiatorEnum' do
    it 'should create an instance of PurchaseInitiatorEnum' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::PurchaseInitiatorEnum)
    end
  end

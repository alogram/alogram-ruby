...
# Unit tests for AlogramPayRisk::SignalsAccountVariant
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::SignalsAccountVariant do
  #let(:instance) { AlogramPayRisk::SignalsAccountVariant.new }

  describe 'test an instance of SignalsAccountVariant' do
    it 'should create an instance of SignalsAccountVariant' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::SignalsAccountVariant)
    end
  end

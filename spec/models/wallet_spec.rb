...
# Unit tests for AlogramPayRisk::Wallet
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::Wallet do
  #let(:instance) { AlogramPayRisk::Wallet.new }

  describe 'test an instance of Wallet' do
    it 'should create an instance of Wallet' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::Wallet)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["wallet"])

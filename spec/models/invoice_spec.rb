...
# Unit tests for AlogramPayRisk::Invoice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::Invoice do
  #let(:instance) { AlogramPayRisk::Invoice.new }

  describe 'test an instance of Invoice' do
    it 'should create an instance of Invoice' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::Invoice)
    end
  end

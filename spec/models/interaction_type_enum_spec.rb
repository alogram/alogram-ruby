...
# Unit tests for AlogramPayRisk::InteractionTypeEnum
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::InteractionTypeEnum do
  #let(:instance) { AlogramPayRisk::InteractionTypeEnum.new }

  describe 'test an instance of InteractionTypeEnum' do
    it 'should create an instance of InteractionTypeEnum' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::InteractionTypeEnum)
    end
  end

...
# Unit tests for AlogramPayRisk::DecisionResolutionRequestAnalyst
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::DecisionResolutionRequestAnalyst do
  #let(:instance) { AlogramPayRisk::DecisionResolutionRequestAnalyst.new }

  describe 'test an instance of DecisionResolutionRequestAnalyst' do
    it 'should create an instance of DecisionResolutionRequestAnalyst' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::DecisionResolutionRequestAnalyst)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["human_merchant", "automated_consensus", "autonomous_agent"])

...
# Unit tests for AlogramPayRisk::CategorySignal
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::CategorySignal do
  #let(:instance) { AlogramPayRisk::CategorySignal.new }

  describe 'test an instance of CategorySignal' do
    it 'should create an instance of CategorySignal' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::CategorySignal)
    end
  end

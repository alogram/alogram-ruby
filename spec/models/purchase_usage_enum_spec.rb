...
# Unit tests for AlogramPayRisk::PurchaseUsageEnum
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::PurchaseUsageEnum do
  #let(:instance) { AlogramPayRisk::PurchaseUsageEnum.new }

  describe 'test an instance of PurchaseUsageEnum' do
    it 'should create an instance of PurchaseUsageEnum' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::PurchaseUsageEnum)
    end
  end

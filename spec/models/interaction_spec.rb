...
# Unit tests for AlogramPayRisk::Interaction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::Interaction do
  #let(:instance) { AlogramPayRisk::Interaction.new }

  describe 'test an instance of Interaction' do
    it 'should create an instance of Interaction' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::Interaction)
    end
  end
  ...
  describe 'test attribute "interaction_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

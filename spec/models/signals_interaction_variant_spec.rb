...
# Unit tests for AlogramPayRisk::SignalsInteractionVariant
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::SignalsInteractionVariant do
  #let(:instance) { AlogramPayRisk::SignalsInteractionVariant.new }

  describe 'test an instance of SignalsInteractionVariant' do
    it 'should create an instance of SignalsInteractionVariant' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::SignalsInteractionVariant)
    end
  end

  describe 'test attribute "signal_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["interaction"])
      # validator.allowable_values.each do |value|
      #   expect { instance.signal_type = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "interactions"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

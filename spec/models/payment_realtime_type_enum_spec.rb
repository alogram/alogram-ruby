...
# Unit tests for AlogramPayRisk::PaymentRealtimeTypeEnum
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::PaymentRealtimeTypeEnum do
  #let(:instance) { AlogramPayRisk::PaymentRealtimeTypeEnum.new }

  describe 'test an instance of PaymentRealtimeTypeEnum' do
    it 'should create an instance of PaymentRealtimeTypeEnum' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::PaymentRealtimeTypeEnum)
    end
  end

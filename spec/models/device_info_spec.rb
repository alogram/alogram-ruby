...
# Unit tests for AlogramPayRisk::DeviceInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::DeviceInfo do
  #let(:instance) { AlogramPayRisk::DeviceInfo.new }

  describe 'test an instance of DeviceInfo' do
    it 'should create an instance of DeviceInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::DeviceInfo)
    end
  end

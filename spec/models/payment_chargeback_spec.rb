...
# Unit tests for AlogramPayRisk::PaymentChargeback
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::PaymentChargeback do
  #let(:instance) { AlogramPayRisk::PaymentChargeback.new }

  describe 'test an instance of PaymentChargeback' do
    it 'should create an instance of PaymentChargeback' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::PaymentChargeback)
    end
  end

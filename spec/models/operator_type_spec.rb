...
# Unit tests for AlogramPayRisk::OperatorType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::OperatorType do
  #let(:instance) { AlogramPayRisk::OperatorType.new }

  describe 'test an instance of OperatorType' do
    it 'should create an instance of OperatorType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::OperatorType)
    end
  end

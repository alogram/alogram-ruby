...
# Unit tests for AlogramPayRisk::ScaMethodEnum
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::ScaMethodEnum do
  #let(:instance) { AlogramPayRisk::ScaMethodEnum.new }

  describe 'test an instance of ScaMethodEnum' do
    it 'should create an instance of ScaMethodEnum' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::ScaMethodEnum)
    end
  end

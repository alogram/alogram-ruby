...
# Unit tests for AlogramPayRisk::AgentProvider
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::AgentProvider do
  #let(:instance) { AlogramPayRisk::AgentProvider.new }

  describe 'test an instance of AgentProvider' do
    it 'should create an instance of AgentProvider' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::AgentProvider)
    end
  end

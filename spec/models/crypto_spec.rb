...
# Unit tests for AlogramPayRisk::Crypto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::Crypto do
  #let(:instance) { AlogramPayRisk::Crypto.new }

  describe 'test an instance of Crypto' do
    it 'should create an instance of Crypto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::Crypto)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["crypto"])

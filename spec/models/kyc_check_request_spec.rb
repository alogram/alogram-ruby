...
# Unit tests for AlogramPayRisk::KycCheckRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::KycCheckRequest do
  #let(:instance) { AlogramPayRisk::KycCheckRequest.new }

  describe 'test an instance of KycCheckRequest' do
    it 'should create an instance of KycCheckRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::KycCheckRequest)
    end
  end
  ...
  describe 'test attribute "event_subtype"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["pre_kyc_check", "doc_scan", "liveness", "address_check", "sanctions_pep"])

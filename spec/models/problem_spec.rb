...
# Unit tests for AlogramPayRisk::Problem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::Problem do
  #let(:instance) { AlogramPayRisk::Problem.new }

  describe 'test an instance of Problem' do
    it 'should create an instance of Problem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::Problem)
    end
  end

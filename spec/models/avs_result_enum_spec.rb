...
# Unit tests for AlogramPayRisk::AvsResultEnum
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::AvsResultEnum do
  #let(:instance) { AlogramPayRisk::AvsResultEnum.new }

  describe 'test an instance of AvsResultEnum' do
    it 'should create an instance of AvsResultEnum' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::AvsResultEnum)
    end
  end

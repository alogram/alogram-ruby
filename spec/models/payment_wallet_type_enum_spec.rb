...
# Unit tests for AlogramPayRisk::PaymentWalletTypeEnum
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::PaymentWalletTypeEnum do
  #let(:instance) { AlogramPayRisk::PaymentWalletTypeEnum.new }

  describe 'test an instance of PaymentWalletTypeEnum' do
    it 'should create an instance of PaymentWalletTypeEnum' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::PaymentWalletTypeEnum)
    end
  end

...
# Unit tests for AlogramPayRisk::RiskLevelEnum
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::RiskLevelEnum do
  #let(:instance) { AlogramPayRisk::RiskLevelEnum.new }

  describe 'test an instance of RiskLevelEnum' do
    it 'should create an instance of RiskLevelEnum' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::RiskLevelEnum)
    end
  end

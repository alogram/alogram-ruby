...
# Unit tests for AlogramPayRisk::ReasonDetail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::ReasonDetail do
  #let(:instance) { AlogramPayRisk::ReasonDetail.new }

  describe 'test an instance of ReasonDetail' do
    it 'should create an instance of ReasonDetail' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::ReasonDetail)
    end
  end

...
# Unit tests for AlogramPayRisk::DecisionResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::DecisionResponse do
  #let(:instance) { AlogramPayRisk::DecisionResponse.new }

  describe 'test an instance of DecisionResponse' do
    it 'should create an instance of DecisionResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::DecisionResponse)
    end
  end
  ...
  describe 'test attribute "decision"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["approve", "review", "decline", "step_up"])
  ...
  describe 'test attribute "decision_at"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "decision_score"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "actions"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["step_up", "throttle", "lock_account", "decline", "queue_review"])
      # validator.allowable_values.each do |value|

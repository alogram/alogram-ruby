...
# Unit tests for AlogramPayRisk::DecisionResponsePolicy
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::DecisionResponsePolicy do
  #let(:instance) { AlogramPayRisk::DecisionResponsePolicy.new }

  describe 'test an instance of DecisionResponsePolicy' do
    it 'should create an instance of DecisionResponsePolicy' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::DecisionResponsePolicy)
    end
  end
  ...
  describe 'test attribute "rule_set"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

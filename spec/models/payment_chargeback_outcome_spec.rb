...
# Unit tests for AlogramPayRisk::PaymentChargebackOutcome
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::PaymentChargebackOutcome do
  #let(:instance) { AlogramPayRisk::PaymentChargebackOutcome.new }

  describe 'test an instance of PaymentChargebackOutcome' do
    it 'should create an instance of PaymentChargebackOutcome' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::PaymentChargebackOutcome)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["won", "lost", "representment", "reversed"])

...
# Unit tests for AlogramPayRisk::CardNetworkEnum
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::CardNetworkEnum do
  #let(:instance) { AlogramPayRisk::CardNetworkEnum.new }

  describe 'test an instance of CardNetworkEnum' do
    it 'should create an instance of CardNetworkEnum' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::CardNetworkEnum)
    end
  end

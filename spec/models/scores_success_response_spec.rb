...
# Unit tests for AlogramPayRisk::ScoresSuccessResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::ScoresSuccessResponse do
  #let(:instance) { AlogramPayRisk::ScoresSuccessResponse.new }

  describe 'test an instance of ScoresSuccessResponse' do
    it 'should create an instance of ScoresSuccessResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::ScoresSuccessResponse)
    end
  end

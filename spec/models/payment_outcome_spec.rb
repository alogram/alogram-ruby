...
# Unit tests for AlogramPayRisk::PaymentOutcome
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::PaymentOutcome do
  #let(:instance) { AlogramPayRisk::PaymentOutcome.new }

  describe 'test an instance of PaymentOutcome' do
    it 'should create an instance of PaymentOutcome' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::PaymentOutcome)
    end
  end
  ...
  describe 'test attribute "chargeback_outcome"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

...
# Unit tests for AlogramPayRisk::RiskBreakdown
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::RiskBreakdown do
  #let(:instance) { AlogramPayRisk::RiskBreakdown.new }

  describe 'test an instance of RiskBreakdown' do
    it 'should create an instance of RiskBreakdown' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::RiskBreakdown)
    end
  end

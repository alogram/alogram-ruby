...
# Unit tests for AlogramPayRisk::KycPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::KycPayload do
  #let(:instance) { AlogramPayRisk::KycPayload.new }

  describe 'test an instance of KycPayload' do
    it 'should create an instance of KycPayload' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::KycPayload)
    end
  end
  ...
  describe 'test attribute "document_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["passport", "national_id", "driver_license", "other"])
  ...
  describe 'test attribute "result"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["passed", "failed", "review", "timeout", "error"])
      # validator.allowable_values.each do |value|

...
# Unit tests for AlogramPayRisk::EntryMethodEnum
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::EntryMethodEnum do
  #let(:instance) { AlogramPayRisk::EntryMethodEnum.new }

  describe 'test an instance of EntryMethodEnum' do
    it 'should create an instance of EntryMethodEnum' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::EntryMethodEnum)
    end
  end

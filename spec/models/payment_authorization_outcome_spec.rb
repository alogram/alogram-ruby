...
# Unit tests for AlogramPayRisk::PaymentAuthorizationOutcome
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::PaymentAuthorizationOutcome do
  #let(:instance) { AlogramPayRisk::PaymentAuthorizationOutcome.new }

  describe 'test an instance of PaymentAuthorizationOutcome' do
    it 'should create an instance of PaymentAuthorizationOutcome' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::PaymentAuthorizationOutcome)
    end
  end

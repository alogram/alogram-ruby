...
# Unit tests for AlogramPayRisk::ScoreRecord
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::ScoreRecord do
  #let(:instance) { AlogramPayRisk::ScoreRecord.new }

  describe 'test an instance of ScoreRecord' do
    it 'should create an instance of ScoreRecord' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::ScoreRecord)
    end
  end

...
# Unit tests for AlogramPayRisk::AgentManifest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::AgentManifest do
  #let(:instance) { AlogramPayRisk::AgentManifest.new }

  describe 'test an instance of AgentManifest' do
    it 'should create an instance of AgentManifest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::AgentManifest)
    end
  end
  ...
  describe 'test attribute "trust_tier"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

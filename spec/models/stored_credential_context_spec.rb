...
# Unit tests for AlogramPayRisk::StoredCredentialContext
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::StoredCredentialContext do
  #let(:instance) { AlogramPayRisk::StoredCredentialContext.new }

  describe 'test an instance of StoredCredentialContext' do
    it 'should create an instance of StoredCredentialContext' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::StoredCredentialContext)
    end
  end

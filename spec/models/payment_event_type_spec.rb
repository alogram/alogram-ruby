...
# Unit tests for AlogramPayRisk::PaymentEventType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::PaymentEventType do
  #let(:instance) { AlogramPayRisk::PaymentEventType.new }

  describe 'test an instance of PaymentEventType' do
    it 'should create an instance of PaymentEventType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::PaymentEventType)
    end
  end

...
# Unit tests for AlogramPayRisk::PaymentEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::PaymentEvent do
  #let(:instance) { AlogramPayRisk::PaymentEvent.new }

  describe 'test an instance of PaymentEvent' do
    it 'should create an instance of PaymentEvent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::PaymentEvent)
    end
  end

...
# Unit tests for AlogramPayRisk::PaymentDisputeOutcome
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::PaymentDisputeOutcome do
  #let(:instance) { AlogramPayRisk::PaymentDisputeOutcome.new }

  describe 'test an instance of PaymentDisputeOutcome' do
    it 'should create an instance of PaymentDisputeOutcome' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::PaymentDisputeOutcome)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["none", "open", "won", "lost", "canceled"])

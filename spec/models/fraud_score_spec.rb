...
# Unit tests for AlogramPayRisk::FraudScore
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::FraudScore do
  #let(:instance) { AlogramPayRisk::FraudScore.new }

  describe 'test an instance of FraudScore' do
    it 'should create an instance of FraudScore' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::FraudScore)
    end
  end

...
# Unit tests for AlogramPayRisk::AuthContext
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::AuthContext do
  #let(:instance) { AlogramPayRisk::AuthContext.new }

  describe 'test an instance of AuthContext' do
    it 'should create an instance of AuthContext' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::AuthContext)
    end
  end

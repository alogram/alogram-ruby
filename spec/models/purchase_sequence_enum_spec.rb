...
# Unit tests for AlogramPayRisk::PurchaseSequenceEnum
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::PurchaseSequenceEnum do
  #let(:instance) { AlogramPayRisk::PurchaseSequenceEnum.new }

  describe 'test an instance of PurchaseSequenceEnum' do
    it 'should create an instance of PurchaseSequenceEnum' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::PurchaseSequenceEnum)
    end
  end

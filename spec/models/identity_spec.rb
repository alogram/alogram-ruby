...
# Unit tests for AlogramPayRisk::Identity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::Identity do
  #let(:instance) { AlogramPayRisk::Identity.new }

  describe 'test an instance of Identity' do
    it 'should create an instance of Identity' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::Identity)
    end
  end
  ...
  describe 'test attribute "email_reputation"' do
    it 'should work' do
      ...
      #   expect { instance.email_reputation = value }.not_to raise_error
      # end
    end
  end

...
# Unit tests for AlogramPayRisk::MerchantContext
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::MerchantContext do
  #let(:instance) { AlogramPayRisk::MerchantContext.new }

  describe 'test an instance of MerchantContext' do
    it 'should create an instance of MerchantContext' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::MerchantContext)
    end
  end

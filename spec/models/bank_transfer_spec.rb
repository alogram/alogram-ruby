...
# Unit tests for AlogramPayRisk::BankTransfer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::BankTransfer do
  #let(:instance) { AlogramPayRisk::BankTransfer.new }

  describe 'test an instance of BankTransfer' do
    it 'should create an instance of BankTransfer' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::BankTransfer)
    end
  end

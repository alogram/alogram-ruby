...
# Unit tests for AlogramPayRisk::Purchase
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::Purchase do
  #let(:instance) { AlogramPayRisk::Purchase.new }

  describe 'test an instance of Purchase' do
    it 'should create an instance of Purchase' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::Purchase)
    end
  end
  ...
  describe 'test attribute "stored_credential"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

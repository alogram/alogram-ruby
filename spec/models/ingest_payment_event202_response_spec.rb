...
# Unit tests for AlogramPayRisk::IngestPaymentEvent202Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::IngestPaymentEvent202Response do
  #let(:instance) { AlogramPayRisk::IngestPaymentEvent202Response.new }

  describe 'test an instance of IngestPaymentEvent202Response' do
    it 'should create an instance of IngestPaymentEvent202Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::IngestPaymentEvent202Response)
    end
  end

...
# Unit tests for AlogramPayRisk::CvvResultEnum
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::CvvResultEnum do
  #let(:instance) { AlogramPayRisk::CvvResultEnum.new }

  describe 'test an instance of CvvResultEnum' do
    it 'should create an instance of CvvResultEnum' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::CvvResultEnum)
    end
  end

...
# Unit tests for AlogramPayRisk::PaymentCaptureOutcome
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::PaymentCaptureOutcome do
  #let(:instance) { AlogramPayRisk::PaymentCaptureOutcome.new }

  describe 'test an instance of PaymentCaptureOutcome' do
    it 'should create an instance of PaymentCaptureOutcome' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::PaymentCaptureOutcome)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["none", "partial", "full", "failed"])

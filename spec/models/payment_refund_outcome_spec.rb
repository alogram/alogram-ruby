...
# Unit tests for AlogramPayRisk::PaymentRefundOutcome
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::PaymentRefundOutcome do
  #let(:instance) { AlogramPayRisk::PaymentRefundOutcome.new }

  describe 'test an instance of PaymentRefundOutcome' do
    it 'should create an instance of PaymentRefundOutcome' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::PaymentRefundOutcome)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["none", "partial", "full"])

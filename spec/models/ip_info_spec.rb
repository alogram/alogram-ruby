...
# Unit tests for AlogramPayRisk::IpInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::IpInfo do
  #let(:instance) { AlogramPayRisk::IpInfo.new }

  describe 'test an instance of IpInfo' do
    it 'should create an instance of IpInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::IpInfo)
    end
  end
  ...
  describe 'test attribute "ip_prefix"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

...
# Unit tests for AlogramPayRisk::PayerTypeEnum
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::PayerTypeEnum do
  #let(:instance) { AlogramPayRisk::PayerTypeEnum.new }

  describe 'test an instance of PayerTypeEnum' do
    it 'should create an instance of PayerTypeEnum' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::PayerTypeEnum)
    end
  end

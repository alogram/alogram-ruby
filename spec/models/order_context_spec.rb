...
# Unit tests for AlogramPayRisk::OrderContext
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::OrderContext do
  #let(:instance) { AlogramPayRisk::OrderContext.new }

  describe 'test an instance of OrderContext' do
    it 'should create an instance of OrderContext' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::OrderContext)
    end
  end
  ...
  describe 'test attribute "shipping_method"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["digital", "ship", "bopis"])

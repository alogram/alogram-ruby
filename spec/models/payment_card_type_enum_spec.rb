...
# Unit tests for AlogramPayRisk::PaymentCardTypeEnum
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::PaymentCardTypeEnum do
  #let(:instance) { AlogramPayRisk::PaymentCardTypeEnum.new }

  describe 'test an instance of PaymentCardTypeEnum' do
    it 'should create an instance of PaymentCardTypeEnum' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::PaymentCardTypeEnum)
    end
  end

...
# Unit tests for AlogramPayRisk::ConfidenceEnum
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::ConfidenceEnum do
  #let(:instance) { AlogramPayRisk::ConfidenceEnum.new }

  describe 'test an instance of ConfidenceEnum' do
    it 'should create an instance of ConfidenceEnum' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::ConfidenceEnum)
    end
  end

...
# Unit tests for AlogramPayRisk::RiskCategoryEnum
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::RiskCategoryEnum do
  #let(:instance) { AlogramPayRisk::RiskCategoryEnum.new }

  describe 'test an instance of RiskCategoryEnum' do
    it 'should create an instance of RiskCategoryEnum' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::RiskCategoryEnum)
    end
  end

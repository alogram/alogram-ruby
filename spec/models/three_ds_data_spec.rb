...
# Unit tests for AlogramPayRisk::ThreeDSData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::ThreeDSData do
  #let(:instance) { AlogramPayRisk::ThreeDSData.new }

  describe 'test an instance of ThreeDSData' do
    it 'should create an instance of ThreeDSData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::ThreeDSData)
    end
  end
  ...
  describe 'test attribute "flow"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["frictionless", "challenge"])
  ...
  describe 'test attribute "liability_shift"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "cavv_present"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

...
# Unit tests for AlogramPayRisk::DecisionResolutionResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::DecisionResolutionResponse do
  #let(:instance) { AlogramPayRisk::DecisionResolutionResponse.new }

  describe 'test an instance of DecisionResolutionResponse' do
    it 'should create an instance of DecisionResolutionResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::DecisionResolutionResponse)
    end
  end

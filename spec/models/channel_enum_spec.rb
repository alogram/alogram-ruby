...
# Unit tests for AlogramPayRisk::ChannelEnum
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::ChannelEnum do
  #let(:instance) { AlogramPayRisk::ChannelEnum.new }

  describe 'test an instance of ChannelEnum' do
    it 'should create an instance of ChannelEnum' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::ChannelEnum)
    end
  end

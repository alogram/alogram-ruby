...
# Unit tests for AlogramPayRisk::ExternalAssessment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::ExternalAssessment do
  #let(:instance) { AlogramPayRisk::ExternalAssessment.new }

  describe 'test an instance of ExternalAssessment' do
    it 'should create an instance of ExternalAssessment' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::ExternalAssessment)
    end
  end

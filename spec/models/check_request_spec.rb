...
# Unit tests for AlogramPayRisk::CheckRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AlogramPayRisk::CheckRequest do
  #let(:instance) { AlogramPayRisk::CheckRequest.new }

  describe 'test an instance of CheckRequest' do
    it 'should create an instance of CheckRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AlogramPayRisk::CheckRequest)
    end
  end
  ...
  describe 'test attribute "event_type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["purchase"])
  ...
  describe 'test attribute "purchase"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "external_assessments"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

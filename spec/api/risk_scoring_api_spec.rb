...
# Unit tests for AlogramPayRisk::RiskScoringApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RiskScoringApi' do
  before do
    # run before each test
    @api_instance = AlogramPayRisk::RiskScoringApi.new
  end
  ...
  describe 'test an instance of RiskScoringApi' do
    it 'should create an instance of RiskScoringApi' do
      expect(@api_instance).to be_instance_of(AlogramPayRisk::RiskScoringApi)
    end
  end

  # unit tests for risk_check

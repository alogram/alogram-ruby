...
# Unit tests for AlogramPayRisk::ForensicDataApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ForensicDataApi' do
  before do
  ...
  describe 'test an instance of ForensicDataApi' do
    it 'should create an instance of ForensicDataApi' do
      expect(@api_instance).to be_instance_of(AlogramPayRisk::ForensicDataApi)
    end
  end

  # unit tests for get_fraud_scores
  ...
  describe 'get_fraud_scores test' do
    it 'should work' do
